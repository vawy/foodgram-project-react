    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Логин может состоять только из латинских букв и цифр', max_length=150, unique=True, validators=[django.core.validators.RegexValidator('^[0-9a-zA-Z]*$', message='Введите логин как указано в подсказке')], verbose_name='Логин')),
